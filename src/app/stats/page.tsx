  ...
  return (
    <>
      <div className=" w-full bg-[#252525] h-screen bg-dot-white/[0.6] relative flex flex-col items-center justify-center text-white gap-5">
        ...
        <div className="p-5">
          <button onClick={() => {window.location.href = '/'}} className="px-4 py-2 rounded-lg bg-gray-800 text-yellow-400 text-xl font-semibold border-2 border-white">Retake test</button>
        </div>

        {
          ...
          ?
          (
          <Link href={'/auth/signup'} className="text-xl text-yellow-300 bg-[#ff5e0057] rounded-full px-3">
