...
const Stats = (props: Props) => {
  ...
  return (
    <>
      <div className=" w-full bg-[#252525] min-h-screen bg-dot-white/[0.6] relative flex flex-col justify-center items-center text-white gap-5">
        ...
        {user ? <Navbar /> : <></>}
          ...
          <button
            ...
            className="mt-5 px-4 py-2 rounded-lg bg-gray-800 text-yellow-400 text-xl font-semibold border-2 border-white"
          >
            Retake test
          </button>
